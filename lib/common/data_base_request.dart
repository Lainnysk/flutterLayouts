abstract class DataBaseRequest {
  ...
  static const String _createTableUsers =
      'CREATE TABLE "$tableUsers" ("id"	INTEGER,"login"	TEXT NOT NULL UNIQUE,"password"	TEXT NOT NULL,"roleId"	INTEGER,FOREIGN KEY("roleId") REFERENCES "Role"("id"),PRIMARY KEY("id" AUTOINCREMENT))';
}
